...
public class PrescriptionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list = new ArrayList<>();
        list.add(new medModel("","Medicine A"));
        list.add(new medModel("","Medicine B"));
        list.add(new medModel("","Medicine C"));
        list.add(new medModel("","Medicine D"));
        list.add(new medModel("","Medicine E"));
        final medAdapter adapter = new medAdapter(list);
